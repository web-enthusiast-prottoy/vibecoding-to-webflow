...
export function mapTailwindToStyles(classes) {
    ...
    classes.forEach(cls => {
        ...
        // Layout
            ...
            styles["gap"] = parseSpacing(cls, "gap-");
        // Typography
        ...
        // Colors
            ...
            styles["background-color"] = parseColor(cls.replace("bg-", ""));
    });
    return styles;
}
function parseSpacing(cls, prefix) {
...
function parseColor(colorToken) {
    ...
    if (colorToken.includes("red-500"))
        return "#ef4444";
    if (colorToken.includes("blue-500"))
        return "#3b82f6";
    if (colorToken === "white")
        return "#ffffff";
    if (colorToken === "black")
