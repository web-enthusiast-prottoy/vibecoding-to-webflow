 ...
 */ var isExtglob = __webpack_require__("./node_modules/.pnpm/is-extglob@2.1.1/node_modules/is-extglob/index.js");
    ...
    "./node_modules/.pnpm/@babel+code-frame@7.29.0/node_modules/@babel/code-frame/lib/index.js" (__unused_rspack_module, exports1, __webpack_require__) {
        ...
        exports1.codeFrameColumns = codeFrameColumns;
    },
...
(()=>{
    ...
    function expand_(str, max, isTop) {
        ...
        if (/\$$/.test(m.pre)) for(let k = 0; k < post.length && k < max; k++){
            ...
            if (isSequence && void 0 !== n[0] && void 0 !== n[1]) {
                ...
                let incr = 3 === n.length && void 0 !== n[2] ? Math.abs(numeric(n[2])) : 1;
                let test = lte;
                const reverse = y < x;
                if (reverse) {
                    incr *= -1;
    ...
    function createCodeFrameFormatter(options) {
        ...
        return function(issue) {
            ...
            let frame = '';
            if (source && issue.location) frame = (0, lib.codeFrameColumns)(source, issue.location, {
                highlightCode: true,
                ...options || {}
