...
type PropValues<NodeType = unknown> = {
    ...
    [PropType.Attributes]: Record<string, string>;
};
type PropSettings = {
    [PropType.Id]: {};
    [PropType.Text]: {};
...
type PropTypesWithoutDefaultValue = PropType.Id | PropType.Link | PropType.Image | PropType.Slot | PropType.Attributes;
...
type BundleConfigOverrideObj = Omit<Configuration, "module"> & {
    ModuleFederationPlugin?: {
        shared?: moduleFederationPlugin.Shared;
    };
    module?: Omit<NonNullable<Configuration["module"]>, "rules"> & {
        rules?: (currentRules: RuleSetRule[]) => RuleSetRule[];
    };
};
type BundleConfigOverrideFn = (env: Environment) => BundleConfigOverrideObj;
type BundleConfigOverride = BundleConfigOverrideObj | BundleConfigOverrideFn;
type BundleConfigOverrides = BundleConfigOverride | BundleConfigOverride[];
...
declare const props: {
    ...
    /**
     * Alias for {@link props.Text}. Creates a prop for plain text input, provided to the component as a `string`.
     *
     * @param opts Configuration options for the text prop
     * @param opts.name The display name of the prop in the Properties panel
     * @param opts.defaultValue An optional default value for the prop on all component instances
     ...
     * @param opts.tooltip An optional tooltip text for the prop in the Properties panel
     */
    String: PropConstructor<PropType.Text>;
    /**
    ...
    /**
     * Alias for {@link props.Slot}. Creates a slot where child components can be added, provided to the component as a node (e.g., `ReactNode` for React).
     *
     * @param opts Configuration options for the slot prop
     * @param opts.name The display name of the prop in the Properties panel
     * @param opts.group An optional group for the prop in the Properties panel
     * @param opts.tooltip An optional tooltip text for the prop in the Properties panel
     */
    Children: PropConstructor<PropType.Slot>;
    /**
    ...
    /**
     * Creates a prop for custom element attributes, provided to the component as
     * a `Record<string, string>` that should be spread onto an element.
     *
     * Attributes props cannot declare a default value — instances always start
     * with an empty attribute map.
     *
     * @param opts Configuration options for the attributes prop
     * @param opts.name The display name of the prop in the Properties panel
     * @param opts.group An optional group for the prop in the Properties panel
     * @param opts.tooltip An optional tooltip text for the prop in the Properties panel
     */
    Attributes: PropConstructor<PropType.Attributes>;
};
